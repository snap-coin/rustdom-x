...
fn test_m128i_from_u8() {
    ...
    let bytes: [u8; 16] = [
        0xf3, 0xe4, 0xf7, 0xd6, 0x16, 0xf6, 0x70, 0xb3, 0x14, 0x29, 0x7a, 0xbb, 0x76, 0x38, 0x90,
        0x31,
    ];
...
fn test_m128d_add() {
    ...
    assert_eq!(
        m_add2,
        m128d::from_f64(788.888 + 63.839, 54920.0 + 65638.3748)
    );
}
...
fn test_m128d_and() {
    ...
    assert_eq!(
        m_anded,
        m128d::from_u64(0xAAAAAAAAAAAAAAAA, 0xAAAAAAAAAAAAAAAA)
    );
}
...
fn test_m128d_xor() {
    ...
    assert_eq!(
        m_xored,
        m128d::from_u64(0x0FFFFFFFFFFFFFFF, 0x0FFFFFFFFFFFFFFF)
    );
    let nulled = m1 ^ m1;
